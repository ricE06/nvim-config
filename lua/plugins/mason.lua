...
local function on_attach(client, bufnr)
	...
	vim.keymap.set("n", "<leader>ca", function()
		...
		buffer = bufnr,
		desc = "the below function should get the code action available on the whole line no matter where are you standing in the line",
	})
...
function M.config()
	...
	mason_lspconfig.setup({
		ensure_installed = { "lua_ls", "clangd", "pyright", "ts_ls", "gopls" },
